"""
Django settings for restless_rain_42894 project.
...
ROOT_URLCONF = 'restless_rain_42894.urls'
...
WSGI_APPLICATION = 'restless_rain_42894.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_rain_42894 API",
    "DESCRIPTION": "API documentation for restless_rain_42894 App",
    "VERSION": "v1",
}
